...
export const featuredWorkflows: FeaturedWorkflow[] = [
  { listingId: '01a0ccea-2449-7796-ba40-bfcded89b97d', url: 'https://www.shengsuanyun.com/zh/loomloom/market/skills/01a0ccea-2449-7796-ba40-bfcded89b97d', title: '电商爆款图复刻', reason: '上传参考图和自己的产品图，复刻构图、配色与氛围，生成同款风格的商品图。', category: '电商图复刻', cover: 'image', authorName: 'user_xwaxxm', referenceFee: { amountT: 100000, currency: 'CNY', checkedAt: '2026-09-23' } },
